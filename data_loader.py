...
class TrainDataset(Dataset):
    ...
    def __init__(self, data: List[str], target_size=(256, 256)):
        """
...
class TrainDataModule(pl.LightningDataModule):
    def __init__(self, split_dir: str, target_size=(256, 256), batch_size: int = 32):
        """
...
class TestDataset(Dataset):
    ...
    def __init__(self, img_csv: str, pos_mask_csv: str, neg_mask_csv: str, target_size=(256, 256)):
        """
